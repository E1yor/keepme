...
INSERT INTO "PUBLIC"."LOAD"("BROKER_NAME", "ORIGIN", "PICKUP_TIME", "DELIVERY_TIME", "RATE", "NOTES", "CREATED", "STATE")
        VALUES  ('JB HUNT', 'CA Pasadena', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 1.5, 'some notes', CURRENT_TIMESTAMP(), 0);
